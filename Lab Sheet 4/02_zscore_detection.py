...
if __name__ == '__main__':
    ...
    extreme_mask = (z > 3).any(axis=1)
    extremes = df[extreme_mask]
    print('Number of extreme rows (|z|>3):', len(extremes))
    extremes.to_csv('outputs/02_extreme_rows.csv', index=False)
    print('Saved outputs/02_extreme_rows.csv')
