...
if __name__ == '__main__':
    ...
    df['x3_x1_ratio'] = df['x3'] / (df['x1'] + 1e-8)
    print(df[['x1','x2','x1_x2_product','x3_x1_ratio']].head())
    df[['x1','x2','x1_x2_product','x3_x1_ratio']].to_csv('outputs/15_product_ratio.csv', index=False)
    print('Saved outputs/15_product_ratio.csv')
