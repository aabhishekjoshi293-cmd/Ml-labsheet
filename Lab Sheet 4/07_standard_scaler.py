...
if __name__ == '__main__':
    ...
    print('Means after scaling:', scaled_df.mean().round(6).to_dict())
    print('Stds after scaling:', scaled_df.std(ddof=0).round(6).to_dict())
    scaled_df.to_csv('outputs/07_scaled.csv', index=False)
    print('Saved outputs/07_scaled.csv')
