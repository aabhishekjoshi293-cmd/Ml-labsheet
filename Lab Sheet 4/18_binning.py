...
if __name__ == '__main__':
    df['x1_bin'] = pd.qcut(df['x1'], q=4, labels=['Q1','Q2','Q3','Q4'])
    print(df[['x1','x1_bin']].head())
    df[['x1','x1_bin']].to_csv('outputs/18_binned.csv', index=False)
    print('Saved outputs/18_binned.csv')
